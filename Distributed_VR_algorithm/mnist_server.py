...
if __name__ == '__main__':
    ...
    X_train, Y_train, X_val, Y_val, X_test, Y_test = read_mnist_wrap(list(range(0,5)), test_pec=0.5)
    X_train2, Y_train2, _, _, _, _ = read_mnist_wrap(list(range(5,10)), test_pec=0.5)
